...
<div class="container-fluid px-4 pb-5">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 mt-3 gap-3">
        ...
        <div class="bg-white p-2 px-3 rounded-4 shadow-sm border border-primary border-opacity-10">
            ...
            <span class="fw-bold small text-dark">Antrean: <?php echo e($approvals->count()); ?> Surat</span>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $approvals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="transition-row">
                        <td class="ps-4">
                            <div class="fw-bold text-dark small"><?php echo e($app->created_at->format('d M Y')); ?></div>
                            <small class="text-muted"><?php echo e($app->created_at->diffForHumans()); ?></small>
                        </td>
                        <td>
                            <div class="fw-bold text-primary mb-0"><?php echo e($app->title); ?></div>
                            <small class="text-muted">Oleh: <b><?php echo e($app->creator->nama_lengkap); ?></b></small>
                        </td>
                        <td>
                        ...
                        <td class="text-center pe-4">
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <button type="button" class="btn btn-outline-info btn-sm rounded-pill px-3 fw-bold shadow-sm" 
                                        data-bs-toggle="modal" data-bs-target="#modalPreview<?php echo e($app->id); ?>">
                                    <i class="fas fa-eye me-1"></i> Detail
                                </button>

                                
                                <form action="<?php echo e(route('assignment.approvals.action', $app->id)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="action" value="approve">
                                    <button type="submit" class="btn <?php echo e($app->reviewed_at ? 'btn-success' : 'btn-primary'); ?> btn-sm rounded-pill px-3 fw-bold shadow-sm">
...
<?php $__env->startPush('modals'); ?>
    ...
    <div class="modal fade" id="modalPreview<?php echo e($app->id); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg rounded-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="bg-light p-3 rounded-4 mb-3">
                                <div class="mb-2">
                                    ...
                                    <span class="fw-bold text-dark"><?php echo e($app->title); ?></span>
                                </div>
                                <div class="mb-2">
                                    <small class="text-muted d-block">Rentang Waktu:</small>
                                    <span class="fw-bold text-dark">
                                        <i class="far fa-calendar-alt me-1 text-primary"></i>
                                        <?php echo e($app->event_date->format('d M Y')); ?> - <?php echo e($app->end_date->format('d M Y')); ?>

                                    </span>
                                </div>
                                <div>
                                    <small class="text-muted d-block">Target:</small>
                                    <span class="badge bg-primary rounded-pill"><?php echo e($app->report_target); ?> Laporan/GC</span>
                                </div>
                            </div>
                            ...
                            <div class="list-group list-group-flush border rounded-4 overflow-hidden shadow-sm">
                                <?php
                                    $pekerja = \App\Models\Agenda::where('title', $app->title)
                                                ...
                                                ->get();
                                ?>
                                <?php $__currentLoopData = $pekerja; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="list-group-item d-flex align-items-center py-2 px-3">
                                    <div class="avatar-mini bg-primary bg-opacity-10 text-primary rounded-circle me-2 d-flex align-items-center justify-content-center" style="width: 28px; height: 28px; font-size: 0.65rem; font-weight: 800;">
                                        <?php echo e(strtoupper(substr($p->assignee->nama_lengkap ?? 'P', 0, 1))); ?>

                                    </div>
                                    <span class="small fw-bold text-dark"><?php echo e($p->assignee->nama_lengkap ?? 'User'); ?></span>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            <div class="mt-3 p-2 bg-success bg-opacity-10 rounded-3 text-center border border-success border-opacity-10">
                                <small class="text-success fw-bold"><i class="fas fa-info-circle me-1"></i> Total: <?php echo e($pekerja->count()); ?> Personel</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer border-0 p-4 pt-0">
                    ...
                    <?php if(auth()->user()->role === 'Kepala' && $app->reviewed_at): ?>
                        <form action="<?php echo e(route('assignment.approvals.action', $app->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="action" value="approve">
...
<link rel="stylesheet" href="<?php echo e(asset('css/pages/assignment-approvals.css')); ?>">
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/assignment/approvals.blade.php ENDPATH**/ ?>