...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('history.index')); ?>" class="text-decoration-none">Riwayat</a></li>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo e(route('history.export', $report->id)); ?>" class="btn btn-danger rounded-pill px-4 fw-bold shadow-sm">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                <div class="text-center mb-4">
                    ...
                    <h5 class="fw-bold mb-1"><?php echo e($agenda->assignee->nama_lengkap); ?></h5>
                    <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-3"><?php echo e($agenda->assignee->role); ?></span>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <p class="text-dark fw-semibold mb-0"><?php echo e($agenda->nomor_surat_tugas ?? '-'); ?></p>
                </div>

                <div class="mb-3">
                    <label class="small text-muted d-block fw-bold text-uppercase mb-1">Tujuan Perjalanan Dinas</label>
                    <p class="text-dark fw-semibold mb-0"><i class="fas fa-map-marker-alt text-danger me-1"></i> <?php echo e($report->lokasi_tujuan); ?></p>
                </div>
                ...
                <div class="row">
                    <div class="col-6 mb-3">
                        ...
                        <p class="text-dark fw-bold mb-0">
                            <?php echo e(\Carbon\Carbon::parse($report->tanggal_lapor)->translatedFormat('d F Y')); ?>
                    ...
                    <div class="col-6 mb-3">
                        ...
                        <p class="text-dark fw-bold mb-0">
                            <?php echo e(\Carbon\Carbon::parse($report->tanggal_lapor)->translatedFormat('l')); ?>
                ...
                <div class="mb-0">
                    ...
                    <p class="text-dark fw-semibold mb-0"><?php echo e($details['responden'] ?? ($agenda->responden ?? '-')); ?></p>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 p-4">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-6">
                        <a href="<?php echo e(asset('storage/' . $photo->photo_path)); ?>" target="_blank">
                            <img src="<?php echo e(asset('storage/' . $photo->photo_path)); ?>" class="img-fluid rounded-3 shadow-sm border" style="height: 100px; width: 100%; object-fit: cover;">
                        </a>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 p-4 p-lg-5 h-100">
                <div class="mb-5">
                    ...
                    <div class="text-dark lh-lg text-justify bg-light p-4 rounded-4" style="white-space: pre-line;">
                        <?php echo nl2br(e($details['aktivitas'] ?? $agenda->aktivitas)); ?>
                ...
                <div class="mb-5">
                    ...
                    <div class="text-dark lh-lg text-justify bg-danger bg-opacity-10 p-4 rounded-4 border-start border-danger border-4" style="white-space: pre-line;">
                        <?php echo nl2br(e($details['permasalahan'] ?? $agenda->permasalahan)); ?>
                ...
                <div class="mb-0">
                    ...
                    <div class="text-dark lh-lg text-justify bg-success bg-opacity-10 p-4 rounded-4 border-start border-success border-4" style="white-space: pre-line;">
                        <?php echo nl2br(e($details['solusi_antisipasi'] ?? $agenda->solusi_antisipasi)); ?>
...
<link rel="stylesheet" href="<?php echo e(asset('css/pages/history-detail.css')); ?>">
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/history/detail.blade.php ENDPATH**/ ?>