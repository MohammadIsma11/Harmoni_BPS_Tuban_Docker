    ...
    <div class="col-12">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
            ...
            <div class="d-flex flex-wrap gap-2">
                <form id="truncateForm" action="<?php echo e(route('manajemen.mitra.truncate')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
        ...
        <div class="card border-0 shadow-sm rounded-4 bg-white p-3 h-100">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <h4 class="fw-bold mb-0 text-primary"><?php echo e($mitras->total()); ?></h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card border-0 shadow-sm rounded-4 bg-white p-3 h-100">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <h4 class="fw-bold mb-0 text-success"><?php echo e($mitras->total()); ?></h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    <td class="ps-4 small text-muted sticky-col-start" style="background: white;"><?php echo e(($mitras->currentPage() - 1) * $mitras->perPage() + $loop->iteration); ?></td>
                    <td class="sticky-col-start" style="left: 50px; background: white;">
                        <div class="fw-bold text-dark mb-0"><?php echo e($mitra->nama_lengkap); ?></div>
                    </td>
                    <td><div class="small"><?php echo e($mitra->posisi ?: '-'); ?></div></td>
                    <td>
                        <span class="badge <?php echo e($mitra->status_seleksi == 'Diterima' ? 'bg-success' : ($mitra->status_seleksi == 'Ditolak' ? 'bg-danger' : 'bg-warning text-dark')); ?> bg-opacity-10 text-<?php echo e($mitra->status_seleksi == 'Diterima' ? 'success' : ($mitra->status_seleksi == 'Ditolak' ? 'danger' : 'warning')); ?> small rounded-pill fw-bold">
                            <?php echo e($mitra->status_seleksi ?: 'Menunggu'); ?>

                        </span>
                    </td>
                    <td><div class="small"><?php echo e($mitra->posisi_daftar ?: '-'); ?></div></td>
                    <td><div class="small text-truncate" style="max-width: 250px;" title="<?php echo e($mitra->alamat_detail); ?>"><?php echo e($mitra->alamat_detail ?: '-'); ?></div></td>
                    <td><div class="small"><?php echo e($mitra->alamat_prov ?: '-'); ?></div></td>
                    <td><div class="small"><?php echo e($mitra->alamat_kab ?: '-'); ?></div></td>
                    <td><div class="small"><?php echo e($mitra->alamat_kec ?: '-'); ?></div></td>
                    <td><div class="small"><?php echo e($mitra->alamat_desa ?: '-'); ?></div></td>
                    <td>
                        <div class="small fw-medium">
                            <?php if($mitra->tempat_lahir): ?> <?php echo e($mitra->tempat_lahir); ?>, <?php endif; ?> 
                            <?php echo e($mitra->tgl_lahir ? $mitra->tgl_lahir->format('d-m-Y') : '-'); ?> 
                            <?php if($mitra->umur): ?> (<?php echo e($mitra->umur); ?>) <?php endif; ?>
                        </div>
                    </td>
                    <td class="text-center"><span class="badge bg-light text-dark border small"><?php echo e($mitra->jenis_kelamin); ?></span></td>
                    <td><div class="small"><?php echo e($mitra->pendidikan ?: '-'); ?></div></td>
                    <td><div class="small"><?php echo e($mitra->pekerjaan ?: '-'); ?></div></td>
                    <td><div class="small text-truncate" style="max-width: 150px;"><?php echo e($mitra->deskripsi_pekerjaan_lain ?: '-'); ?></div></td>
                    <td><div class="small"><?php echo e($mitra->no_telp ?: '-'); ?></div></td>
                    <td><span class="badge bg-light text-primary border font-monospace small"><?php echo e($mitra->sobat_id); ?></span></td>
                    <td><div class="small"><?php echo e($mitra->email ?: '-'); ?></div></td>
                    <?php if(Auth::user()->role === 'Admin'): ?>
                    <td class="pe-4 text-end sticky-col-end" style="background: white;">
                        <div class="d-inline-flex gap-1">
                            <a href="<?php echo e(route('manajemen.mitra.edit', $mitra->sobat_id)); ?>" class="p-1" title="Edit">
                                <i class="fas fa-edit text-warning"></i>
                            </a>
                            <form id="deleteForm<?php echo e($mitra->sobat_id); ?>" action="<?php echo e(route('manajemen.mitra.destroy', $mitra->sobat_id)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="button" class="border-0 bg-transparent p-1" onclick="confirmDelete('<?php echo e($mitra->sobat_id); ?>', '<?php echo e($mitra->nama_lengkap); ?>')">
                ...
                <tr>
                    <td colspan="<?php echo e(Auth::user()->role === 'Admin' ? 19 : 18); ?>" class="text-center py-5">
...
<div class="modal fade" id="importModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <form id="importForm" action="<?php echo e(route('manajemen.mitra.import')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/manajemen/mitra/index.blade.php ENDPATH**/ ?>