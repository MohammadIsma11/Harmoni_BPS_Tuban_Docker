                            ...
                            <div class="col-md-6 ps-md-4">
                                ...
                                <div class="mb-4">
                                    <?php if($user->role == 'Pegawai'): ?>
                                        ...
                                        <div class="p-3 border rounded-4 bg-white shadow-sm <?php echo e($user->has_super_access ? 'border-danger border-opacity-50' : ''); ?>">
                                            <div class="form-check form-switch d-flex align-items-center justify-content-between ps-0">
                                                <div class="me-3">
                                                    <label class="form-check-label fw-bold <?php echo e($user->has_super_access ? 'text-danger' : 'text-dark'); ?> d-block mb-0" for="superAccessSwitch">
                                                        Mode Akses Monitoring
                                                    </label>
                                                    <small class="text-muted" style="font-size: 0.7rem;">
                                                        <?php echo e($user->has_super_access ? 'Tiket akses aktif. Matikan untuk kembali ke mode pegawai biasa.' : 'Aktifkan untuk memantau seluruh riwayat kegiatan organisasi.'); ?>
                                                ...
                                                <input class="form-check-input ms-0 mt-0 shadow-none" type="checkbox" name="has_super_access" role="switch" id="superAccessSwitch" value="1" 
                                                    <?php echo e($user->has_super_access ? 'checked' : ''); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex flex-column gap-3">
                                        ...
                                        <?php elseif(($user->role === 'Katim' || $user->role === 'Kepala') || ($user->has_super_access == 1 && in_array($user->username, ['kepala.bps', 'ketua.tim', 'dodik.hendarto', 'respati.yekti', 'umdatul.ummah', 'ika.rahmawati', 'arif.suroso', 'triana.puji', 'yudhi.prasetyono', 'wicaksono']))): ?>
                                            <?php 
                                            ...
                                            <div class="role-selection mb-1">
                                                <input type="radio" name="role" id="roleOriginal" value="<?php echo e($displayRole); ?>" class="btn-check" <?php echo e($user->role != 'Pegawai' ? 'checked' : ''); ?>>
                                                <label class="btn btn-outline-light text-start p-3 w-100 rounded-4 shadow-xs border" for="roleOriginal">
                                                    <div class="d-flex align-items-center">
                                                        <div class="icon-box me-3 bg-primary bg-opacity-10 text-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
                                                            <i class="fas <?php echo e($displayRole == 'Kepala' ? 'fa-user-tie' : 'fa-users-cog'); ?>"></i>
                                                        </div>
                                                        <div>
                                                            <div class="fw-bold text-dark"><?php echo e($displayRole); ?></div>
                                            ...
                                            <div class="role-selection">
                                                <input type="radio" name="role" id="rolePegawai" value="Pegawai" class="btn-check" <?php echo e($user->role == 'Pegawai' ? 'checked' : ''); ?>>
